...
<html>
  ...
  String kind=(String)session.getAttribute("kind");
    ...
    <iframe name="topnavi" src="student_navi.jsp" width="1024" height="139" scrolling="no" frameborder="0"></iframe>
    </td></tr>
    <tr><td width="1024" height="661">
    <iframe name="mainframe" src="student_main.jsp" width="1024" height="661" scrolling="no" frameborder="0"></iframe>
    </td></tr>
    </table>
