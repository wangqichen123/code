...
Sc cou[]=new Sc[n];
 ...
 <table border="1" align="center" cellspacing="0" cellpadding="0">
    <tr align="center"><td width="80">学号</td><td width="80">姓名</td><td width="160">专业</td><td width="100" >班级</td><td>总学分</td></tr>
    <tr align="center"><td width="80"><%=stu.getSid() %></td><td><%=stu.getSname() %></td><td><%=stu.getSmajor() %></td><td><%=stu.getSclass() %></td><td><%=stu.getTcredit() %></td></tr>
    </table>
    <br/>
