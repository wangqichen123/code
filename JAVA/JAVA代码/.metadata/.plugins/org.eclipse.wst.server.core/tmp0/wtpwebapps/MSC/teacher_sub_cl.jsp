...
<html>
  ...
  <div align="center"><font size="5" color="#000080" face="华文楷体"><b>开设课程信息如下：<br><br></b></font></div>
     ...
     <tr align="center"><td width="150">课序号</td><td width="150">课程名</td><td>导出成绩Excel表</td><%if(con.equals("subing")){ %><%} %><td>查看成绩</td></tr>
	<%
	for(int j=0;j<i;j++){
	...
	%>
            	<tr align="center">
		    		...
		    		<%if(con.equals("subing")){ %>
		    		<%} %>
		    		<td><a href="teacher_sub_rs.jsp?cno=<%=cno %>&tid=<%=tid %>&con=<%=con %>&xls=no">查看</a></td>
