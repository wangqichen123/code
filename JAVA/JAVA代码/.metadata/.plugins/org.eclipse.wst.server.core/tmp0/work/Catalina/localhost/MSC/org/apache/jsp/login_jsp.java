 ...
 * Generated at: 2018-03-12 09:15:01 UTC
...
return;
    ...
    try {
      ...
      out.write("<html>\r\n");
      out.write("\t<head>\r\n");
      out.write("\t\t<title>学生成绩管理系统-登录</title>\r\n");
      ...
      out.write("\r\n");
      out.write("\t<body>\r\n");
      out.write("\t\t<form name=\"formlogin\" action=\"login_conf\" method=\"post\" onSubmit=\"return isValid(this);\">\r\n");
      out.write("\t\t\t<table width=\"8oo\" height=\"600\" border=\"0\" align=\"center\">\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th width=\"800\" height=\"80\" colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src=\"image/login1.jpg\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th width=\"800\" height=\"138\" colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src=\"image/login3.jpg\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"165\" height=\"187\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src=\"image/login5.jpg\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<table width=\"481\" height=\"187\" border=\"0\" cellpadding=\"0\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"kind\" value=\"admin\" checked />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t管理员\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"kind\" value=\"teacher\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t老师&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"radio\" name=\"kind\" value=\"student\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t学生\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td width=\"154\" height=\"187\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src=\"image/login6.jpg\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th width=\"800\" height=\"106\" colspan=\"3\" align=\"right\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tbackground=\"image/login4.jpg\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<marquee style=\"FILTER: blur(direction = 135, strength = 8)\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tbehavior=\"alternate\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<font size=\"+3\" face=\"华文行楷\" color=\"#0e87d1\"><i>欢迎使用学生成绩管理系统！</i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</font>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</marquee>\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<img src=\"image/login2.jpg\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t</th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
